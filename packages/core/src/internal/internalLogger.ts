import { LogLevel, type LogLevelString, type SigcordLoggerMeta, getConfig } from '../config.js';
...
export class InternalLogger {
  ...
  debug(msg: string, maybeLazyMeta?: SigcordLoggerMeta | (() => SigcordLoggerMeta)) {
    if (shouldLog(LogLevel.debug)) {
      const meta = typeof maybeLazyMeta === 'function' ? maybeLazyMeta() : maybeLazyMeta;
